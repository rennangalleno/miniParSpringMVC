<%@ include file="/WEB-INF/views/cabecalho.jsp" %>
	...
	<form:form class="form-horizontal"  action="/minipar/cartao/edita" method="POST" modelAttribute="cartao">
		<div class="container">
		...
		<div class="panel panel-default">
			...
			<div class="panel-heading">
		   		<div class="clearfix">
		   			<h1 class="panel-title aw-titulo-panel">Alterar Cartão</h1>
		   		</div>
		   	</div>
			...
			<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-1 control-label">Id:</label>
							...
							<form:hidden path="id" value="${cartao.id}"/>	
					</div>
			
					<div class="form-group">
						<label class="col-sm-1 control-label">Bandeira:</label>
						<div class="col-sm-4">
							<form:select class="form-control" path="bandeira.id">

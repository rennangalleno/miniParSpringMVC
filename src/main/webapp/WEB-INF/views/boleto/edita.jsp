<%@ include file="/WEB-INF/views/cabecalho.jsp" %>
	...
	<form:form class="form-horizontal"  action="/minipar/boleto/edita" method="POST" modelAttribute="boleto">
		<div class="container">
		...
		<div class="panel panel-default">
			...
			<div class="panel-heading">
		   		<div class="clearfix">
		   			<h1 class="panel-title aw-titulo-panel">Alterar Boleto</h1>
		   		</div>
		   	</div>
			...
			<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-1 control-label">Id:</label>
							...
							<form:hidden path="id" value="${boleto.id}"/>	
					</div>

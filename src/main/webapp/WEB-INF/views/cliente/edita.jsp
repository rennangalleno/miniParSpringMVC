...
<div class="container">
	<form:form class="form-horizontal" action="/minipar/cliente/edita" method="POST" modelAttribute="cliente">
		
		<div class="panel panel-default">
	
			<div class="panel-heading">
		   		<div class="clearfix">
		   			<h1 class="panel-title aw-titulo-panel">Alterar cliente</h1>
		   		</div>
		   	</div>
			...
			<div class="panel-body">
					...
					<form:hidden path="conta.id" value="${cliente.conta.id}"/>
